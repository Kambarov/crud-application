                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                                <input type="text" name="name[ru]" class="form-control @error('name.ru') is-invalid @enderror"
                                                                       value="{{ old('name.ru', $post->getTranslation('name', 'ru')) }}" required placeholder="@lang('admin.name') RU">
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative">
                                                                <textarea class="form-control @error('description.ru') is-invalid @enderror" name="description[ru]"
                                                                          placeholder="@lang('admin.description') RU" required id="description_ru">{{ old('description.ru', $post->getTranslation('description', 'ru')) }}</textarea>
                                                            </fieldset>
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                                <input type="text" name="name[en]" class="form-control @error('name.en') is-invalid @enderror"
                                                                       value="{{ old('name.en', $post->getTranslation('name', 'en')) }}" required placeholder="@lang('admin.name') EN">
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-help-circle"></i>
                                                                </div>
                                                            </fieldset>
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative">
                                                                <textarea class="form-control @error('description.en') is-invalid @enderror" name="description[en]"
                                                                          placeholder="@lang('admin.description') EN" required id="description_en">{{ old('description.en', $post->getTranslation('description', 'en')) }}</textarea>
                                                            </fieldset>
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                        <input type="number" name="chat_id" class="form-control @error('chat_id') is-invalid @enderror"
                                                               value="{{ old('chat_id', $post->chat_id) }}" placeholder="@lang('admin.posts.chat_id')">
                                                        <div class="form-control-position">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                        <input type="text" name="bot_token" class="form-control @error('bot_token') is-invalid @enderror"
                                                               value="{{ old('bot_token', $post->bot_token) }}" placeholder="@lang('admin.posts.bot_token')">
                                                        <div class="form-control-position">
                                        ...
                                        <div class="text-center">
                                            <img id="uploadPreview" style="width: 200px; height: auto" src="{{ $post->image->url }}" />
                                        </div>
