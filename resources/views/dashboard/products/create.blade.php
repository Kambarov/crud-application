                            ...
                            <form method="post" action="{{ route('dashboard.products.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative">
                                                                <textarea class="form-control @error('brief_description.ru') is-invalid @enderror" name="brief_description[ru]"
                                                                          placeholder="@lang('admin.products.brief_description') RU" required id="settings_ru">{{ old('brief_description.ru') }}</textarea>
                                                            </fieldset>
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative">
                                                                <textarea class="form-control @error('characteristics.ru') is-invalid @enderror" name="characteristics[ru]"
                                                                          placeholder="@lang('admin.products.characteristics') RU" required id="characteristics_ru">{{ old('characteristics.ru') }}</textarea>
                                                            </fieldset>
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative">
                                                                <textarea class="form-control @error('brief_description.en') is-invalid @enderror" name="brief_description[en]"
                                                                          placeholder="@lang('admin.products.brief_description') EN" required id="settings_en">{{ old('brief_description.en') }}</textarea>
                                                            </fieldset>
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative">
                                                                <textarea class="form-control @error('characteristics.uz') is-invalid @enderror" name="characteristics[en]"
                                                                          placeholder="@lang('admin.products.characteristics') EN" required id="characteristics_en">{{ old('characteristics.en') }}</textarea>
                                                            </fieldset>
                                        ...
                                        <div class="controls">
                                            <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                <input type="text" name="video_link" class="form-control @error('video_link') is-invalid @enderror"
                                                       value="{{ old('video_link') }}" placeholder="@lang('admin.products.video_link')">
                                                <div class="form-control-position">
                                        ...
                                        <div class="custom-file">
                                            <input id="uploadImage1" class="custom-file-input" required type="file" name="icon" onchange="PreviewImage1();" />
                                            <label class="custom-file-label">@lang('admin.only_types')</label>
                                        </div>
                                        <br><br>
                                        <div class="text-center">
