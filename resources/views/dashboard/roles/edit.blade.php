...
@section('content')
    <section>
        <form class="form form-vertical" action="{{ route('dashboard.roles.update', $role->id) }}" method="post">
            @csrf
            @method('PUT')
        <!-- Account-begins -->
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="first-name-vertical" required class="form-control @error('name.ru') is-invalid @enderror"
                                                       name="name[ru]" value="{{ old('name.ru', $role->getTranslation('name', 'ru')) }}" placeholder="@lang('admin.name') RU">
                                                @error('name.ru')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="first-name-vertical" required class="form-control @error('name.en') is-invalid @enderror"
                                                       name="name[en]" value="{{ old('name.en', $role->getTranslation('name', 'en')) }}" placeholder="@lang('admin.name') EN">
                                                @error('name.en')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <li class="list-group-item d-flex pt-1 pb-1">
                                            ...
                                            <div class="custom-control custom-switch custom-switch-primary ml-auto">
                                                <input type="checkbox" name="permissions[users][create]" value="true"
                                                       {{ !empty($role->permissions['users']['create']) && $role->permissions['users']['create'] == true ? 'checked' : '' }}
                                        ...
                                        <li class="list-group-item d-flex pt-1 pb-1">
                                            ...
                                            <div class="custom-control custom-switch custom-switch-primary ml-auto">
                                                <input type="checkbox" name="permissions[users][delete]" value="true"
                                                       {{ !empty($role->permissions['users']['delete']) && $role->permissions['users']['delete'] == true ? 'checked' : '' }}
