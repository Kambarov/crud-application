        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('admin.partners.data_table')</h4>
                    <a href="{{ route('dashboard.partners.create') }}" class="btn btn-outline-primary btn-xs btn-icon">
                                ...
                                <tbody>
                                    @forelse($partners as $item)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route('dashboard.partners.edit', $item->id) }}" class="btn btn-icon btn-warning
                                                 btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="@lang('admin.edit')">
                                                    <i class="fa fa-edit"></i>
                                                </a>

                                                <a href="{{ route('dashboard.partners.destroy', $item->id) }}" onclick="return confirm('@lang('admin.are_you_sure')')"
