...
@section('title', trans('admin.edit').' '.$vacancy->name.' - ')
                                        ...
                                        <div class="controls">
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                                <input type="text" name="name[ru]" class="form-control @error('name.ru') is-invalid @enderror"
                                                                       value="{{ old('name.ru', $vacancy->getTranslation('name', 'ru')) }}" required placeholder="@lang('admin.name') RU">
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative">
                                                                <textarea class="form-control @error('description.ru') is-invalid @enderror" name="description[ru]"
                                                                          placeholder="@lang('admin.description') RU" required id="description_ru">{{ old('description.ru', $vacancy->getTranslation('description', 'ru')) }}</textarea>
                                                            </fieldset>
                                                    ...
                                                    <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                                <input type="text" name="name[en]" class="form-control @error('name.en') is-invalid @enderror"
                                                                       value="{{ old('name.en', $vacancy->getTranslation('name', 'en')) }}" required placeholder="@lang('admin.name') EN">
                                                                <div class="form-control-position">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <textarea class="form-control @error('description.en') is-invalid @enderror" name="description[en]"
                                                                      placeholder="@lang('admin.description') EN" required id="description_en">{{ old('description.en', $vacancy->getTranslation('description', 'en')) }}</textarea>
                                                            </fieldset>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    <input type="checkbox" name="status" {{ $vacancy->status ? 'checked' : '' }} value="1">
