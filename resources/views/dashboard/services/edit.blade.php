...
@section('title', trans('admin.edit').' '.$service->name.' - ')
                                    ...
                                    <div class="col-md-12">
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                                <input type="text" name="name[ru]" class="form-control @error('name.ru') is-invalid @enderror"
                                                                       value="{{ old('name.ru', $service->getTranslation('name', 'ru')) }}" required placeholder="@lang('admin.name') RU">
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative">
                                                                <textarea class="form-control @error('description.ru') is-invalid @enderror" name="description[ru]"
                                                                          placeholder="@lang('admin.description') RU" required>{{ old('description.ru', $service->getTranslation('description', 'ru')) }}</textarea>
                                                            </fieldset>
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                                <input type="text" name="name[en]" class="form-control @error('name.en') is-invalid @enderror"
                                                                       value="{{ old('name.en', $service->getTranslation('name', 'en')) }}" required placeholder="@lang('admin.name') EN">
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-help-circle"></i>
                                                                </div>
                                                            </fieldset>
                                                        ...
                                                        <div class="controls">
                                                            <fieldset class="form-group position-relative">
                                                                <textarea class="form-control @error('description.en') is-invalid @enderror" name="description[en]"
                                                                          placeholder="@lang('admin.description') EN" required>{{ old('description.en', $service->getTranslation('description', 'en')) }}</textarea>
                                                            </fieldset>
                                        ...
                                        <fieldset class="form-group">
                                            <select class="select2 form-control" name="type" required>
                                                ...
                                                <option value="service" {{ $service->type === 'service' ? 'selected' : '' }}>@lang('admin.services.service')</option>
                                                <option value="utility" {{ $service->type === 'utility' ? 'selected' : '' }}>@lang('admin.services.utility')</option>
                                            </select>
                                        </fieldset>
                                        ...
                                        <div class="text-center">
                                            <img id="uploadPreview" style="width: 200px; height: auto" src="{{ $service->media->url ?? '' }}"/>
                                        </div>
...
@push('js')
    ...
    <script src="/vendor/dashboard/app-assets/js/scripts/forms/select/form-select2.js">
